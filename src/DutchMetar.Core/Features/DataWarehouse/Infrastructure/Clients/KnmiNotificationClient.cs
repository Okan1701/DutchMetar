...
using DutchMetar.Core.Features.DataWarehouse.Infrastructure.Clients.Contracts.Notifications;
...
namespace DutchMetar.Core.Features.DataWarehouse.Infrastructure.Clients;
...
public class KnmiNotificationClient : IKnmiNotificationClient
{
    ...
    private const string _topic = "dataplatform/file/v1/metar/1.0/#";
