...
public class ProcessKnmiMetarFilesFeature
{
    ...
    public ProcessKnmiMetarFilesFeature(DutchMetarContext dbContext, ILogger<ProcessKnmiMetarFilesFeature> logger, IKnmiMetarFileClient knmiFileClient)
    {
