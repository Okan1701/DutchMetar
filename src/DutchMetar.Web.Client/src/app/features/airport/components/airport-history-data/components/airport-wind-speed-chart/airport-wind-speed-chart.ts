...
@Component({
    ...
    templateUrl: './airport-wind-speed-chart.html',
    styleUrl: './airport-wind-speed-chart.scss',
})
export class AirportWindSpeedChart {
            ...
            series: [
                {
                    ...
                    data: history.map((d) => d.windSpeedKnots ?? null),
                },
            ],
            chart: {
                type: 'line',
